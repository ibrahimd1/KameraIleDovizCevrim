...
/**
 * Created by Ibrahim on 30.01.2019.
 */
...
public class PreviewDemo extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnprevfoto=(Button)findViewById(R.id.buttonprevfoto);
        btnprevfoto.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void scanPhoto(final String imageFileName) {
        msConn = new MediaScannerConnection(PreviewDemo.this, new MediaScannerConnection.MediaScannerConnectionClient() {
            public void onMediaScannerConnected() {
                ...
                Log.i("msClient objility", "connection established");
            }
            public void onScanCompleted(String path, Uri uri) {
                msConn.disconnect();
                Log.i(" in Photo Utility", "scan completed");
            }
        });
        msConn.connect();
    }
